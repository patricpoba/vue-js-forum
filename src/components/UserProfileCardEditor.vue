...
<script>
    export default {
      ...
      data () {
        return {
          // clone this.user else after saving this.user would be bound activeUser
          // and further editing would trickle down to the store even before that save button is clicked.
